...
local NoHyper = {
	...
	MAIN       = Color3.fromRGB(220, 38, 38),
	STROKE     = Color3.fromRGB(20, 20, 20),
	TOUCH      = Color3.fromRGB(140, 20, 20),
...
function NoHyper.set_theme(name:string) -- [[ YOU CAN CUSTOM THEME ]]
	...
	elseif name:lower() == 'amoled' then
		NoHyper.Theme.BACKGROUND = Color3.fromRGB(0, 0, 0)        -- preto amoled
		NoHyper.Theme.SECTION    = Color3.fromRGB(8, 8, 8)        -- preto profundo
		NoHyper.Theme.MAIN       = Color3.fromRGB(220, 38, 38)    -- vermelho forte
		NoHyper.Theme.STROKE     = Color3.fromRGB(20, 20, 20)     -- borda discreta
		NoHyper.Theme.TOUCH      = Color3.fromRGB(140, 20, 20)    -- vermelho escuro
		NoHyper.Theme.SYSTEM     = Color3.fromRGB(255, 255, 255)  -- branco limpo
	end
end
